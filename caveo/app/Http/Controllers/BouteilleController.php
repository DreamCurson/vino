...
class BouteilleController extends Controller
{
    ...
    public function storeFromCellier(Request $request, Cellier $cellier)
    {
        ...
        // Sécurité : vérifier que le cellier appartient à l'utilisateur
        abort_if(
        ...
        // Création de la bouteille (non listée)
        $bouteille = Bouteille::create([
            ...
            // Important : indique que ce n'est pas une bouteille SAQ
            'est_saq' => false,
        ]);

        // Ajout dans l'inventaire du cellier
        Inventaire::create([
