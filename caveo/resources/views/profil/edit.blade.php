        ...
        <form method="POST" action="{{ route('profil.update') }}">
            ...
            <div class="border rounded-lg shadow p-2 bg-white">
                <div class="p-2 flex flex-col">
                    <div class="mb-2">
                        <label for="prenom" class="block text-md font-medium text-gray-500">
                            Prénom</label>
                        <input type="text" name="prenom" 
                                value="{{ $user->prenom }}" 
                                class="block w-full border-2 text-[#1A1A1A] rounded-lg p-1 focus:outline-none focus:ring-1 focus:ring-[#A83248] focus:border-[#A83248]">
                    </div>
                    <div class="mb-2">
                        <label for="nom" class="block text-md font-medium text-gray-500">
                            Nom</label>
